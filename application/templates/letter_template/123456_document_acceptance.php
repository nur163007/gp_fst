...
<div class="panel-body container-fluid" style="border: solid 1px #000; height: 842px; width: 595px; font-size: 15px;" id="lcDocAcceptanceLetter" class="">
<p><?php echo date("F").' '.date("d").', ',date("Y"); ?></p>
<p>Ref: ##LCNO##/<?php echo date("y").''.date("m").'',date("d"); ?>/LCO</p>

<p>Manager<br />##BANKNAME##<br />##BANKADDRESS##</p>
<p>&nbsp;</p>
<p>Subject: Delivery of original shipping documents under L/C No. ##LCNO##.</p>
<p>&nbsp;</p>
<p>Dear Sir,</p>
<p>We refer to your e-mail dated: ##BANKNOTICEDATE## for the aforesaid L/C and hereby provide acceptance for releasing ##STATUS## shipping documents against the same.</p>
<p>Therefore, please provide us the original shipping documents related to the same L/C for the amount of ##CUR## ##LCAMOUNT## (##CUR## ##INWORD## Only).</p>
<p>&nbsp;</p>
