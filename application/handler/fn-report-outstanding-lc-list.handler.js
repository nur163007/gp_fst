...
function refreshNonSumReport(){
    if(!dtInit){
        ...
        $('#dtOutstanding').DataTable({
            ...
            "ajax": 'api/fn-report-outstanding-lc-list?action=1&bank='+bank+"&supplier="+supplier+"&expiry="+expiry+"&isSum="+showSum,
            "columns": [
                { "data": "lcno" },
                { "data": "bank" },
                { "data": "pono" },
    			...
    			{ "data": "endValue", "class":"text-right" },
                { "data": "totalPayment", "class":"text-right" },
                { "data": "osLCValue", "class":"text-right" },
                { "data": "osEndValue", "class":"text-right" },
        ...
        var table = $('#dtOutstanding').DataTable();
        $('#exportBtn').empty();
        ...
        dtable.api().ajax.url('api/fn-report-outstanding-lc-list?action=1&bank='+bank+"&supplier="+supplier+"&expiry="+expiry+"&isSum="+showSum).load();
    }
}
...
function refreshSumReport(){
    ...
    if(!dtInitSum){
        ...
        $('#dtOutstandingSummary').DataTable({
            ...
            "ajax": 'api/fn-report-outstanding-lc-list?action=1&isSum='+showSum+'&sumBy='+summaryBy,
            "columns": [
    			{ "data": "sumByColumn" },
        ...
        var table = $('#dtOutstandingSummary').DataTable();
        $('#exportBtn').empty();
        var buttons = new $.fn.dataTable.Buttons(table, {
            buttons: ['excelHtml5']
        }).container().appendTo($('#exportBtn'));
        ...
        dtable.api().ajax.url('api/fn-report-outstanding-lc-list?action=1&isSum='+showSum+'&sumBy='+summaryBy).load();
    }
}
