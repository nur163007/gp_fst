...
<head>
    ...
    <meta name="description" content="Grameenphone Finance-Sourcing Tool or FST, developed and maintained by Aqa Technology." />
...
<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
            ...
            <span class="navbar-brand-text">FS Tool <span class="comment-meta" style="color: white;">3.1 (Test)</span></span>
        </div>
    </div>
                ...
                <li class="dropdown">
                    <a class="navbar-avatar dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false"
                        ...
                        <span class="avatar avatar-online">
                            <img src="<?php if($_SESSION[session_prefix.'wclogin_proPic']==""){echo'assets/portraits/1.jpg' ;}else{echo $_SESSION[session_prefix.'wclogin_proPic'] ;}  ?>" alt="...">
                            <i></i>
                        </span>
                    </a>
