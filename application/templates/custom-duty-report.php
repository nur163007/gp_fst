                ...
                <!--form class="form-horizontal" id="outstanding-form" name="outstanding-form" method="post" autocomplete="off"-->
                    ...
                    <div class="row row-lg">
                        ...
                        <div class="col-xlg-12 col-md-12">
                            <h4 class="well well-sm example-title">Custom Duty Report
                                    ...
                                    <div class="input-daterange" data-plugin="datepicker">
                                        ...
                                        <span class="input-group-addon">
                                          <i class="icon wb-calendar" aria-hidden="true"></i>
                                            ...
                                            <input type="text" class="form-control" name="dtpStart" id="dtpStart" readonly />
                                        </div>
                                        <div class="input-group">
                                            <span class="input-group-addon">to</span>
                                            <input type="text" class="form-control" name="dtpEnd" id="dtpEnd" readonly />
                                        </div>
                                    </div>
                                </div>
                            </div>
